...
/* themes/custom_theme/templates/system/block/block--sitebranding.html.twig */
class __TwigTemplate_a18669ef0f6bae3b0945b7ea5a909944 extends Template
{
    private $source;
    private $macros = [];
    ...
    {
        $macros = $this->macros;
        $this->parent = $this->loadTemplate("block.html.twig", "themes/custom_theme/templates/system/block/block--sitebranding.html.twig", 1);
  ...
  ";
    ...
    {
        return "themes/custom_theme/templates/system/block/block--sitebranding.html.twig";
    }
...
{% block content %}
  {% if site_logo %}
    <a href=\"{{ path('<front>') }}\" rel=\"home\" class=\"site-logo\">
      <img src=\"{{ site_logo }}\" alt=\"{{ 'Home'|t }}\" class=\"w-52 lg:w-[100%]\"/>
    </a>
  {% endif %}
  {% if site_name %}
    <div class=\"site-name\">
  ...
  {% endif %}
{% endblock %}
", "themes/custom_theme/templates/system/block/block--sitebranding.html.twig", "C:\\Users\\Admin\\Desktop\\New folder\\saigon-academy\\web\\themes\\custom_theme\\templates\\system\\block\\block--sitebranding.html.twig");
    }
