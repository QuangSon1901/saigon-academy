...
class __TwigTemplate_1eff47aa720fc0abd8eb6e7afb54964c extends Template
{
    private $source;
    private $macros = [];
...
($context["node"] ?? null), "_entity", [], "any", false, false, true, 13), "field_image_edu", [], "any", false, false, true, 13), "alt", [], "any", false, false, true, 13), "#attributes" => ["class" => "w-full h-full transition-all !duration-1000 !ease-out"]];
    ...
    {
        return new Source("", "modules/custom/custom_view_background/templates/views-custom-view-background.html.twig", "C:\\Users\\Admin\\Desktop\\New folder\\saigon-academy\\web\\modules\\custom\\custom_view_background\\templates\\views-custom-view-background.html.twig");
    }
