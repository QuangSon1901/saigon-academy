...
/* themes/custom_theme/templates/system/breadcumbs/breadcrumb.html.twig */
class __TwigTemplate_94e80a3c11d2405fae765e3c64eff20d extends Template
{
    private $source;
    private $macros = [];
    ...
    protected function doDisplay(array $context, array $blocks = [])
    {
        ...
        if (($context["breadcrumb"] ?? null)) {
            // line 11
            echo "  <nav class=\"breadcrumb h-[100px] lg:h-[150px] flex items-end !pb-5\" role=\"navigation\" aria-labelledby=\"system-breadcrumb\">
    ...
    ";
        ...
        ";
                ...
                if (twig_get_attribute($this->env, $this->source, $context["item"], "url", [], "any", false, false, true, 16)) {
                    ...
                    echo "\" class=\"breadcrumb__link !text-white text-base lg:text-xl\">";
...
";
    ...
    {
        return "themes/custom_theme/templates/system/breadcumbs/breadcrumb.html.twig";
    }
...
#}
{% if breadcrumb %}
  <nav class=\"breadcrumb h-[100px] lg:h-[150px] flex items-end !pb-5\" role=\"navigation\" aria-labelledby=\"system-breadcrumb\">
    <h2 id=\"system-breadcrumb\" class=\"visually-hidden\">{{ 'Breadcrumb'|t }}</h2>
    <ol class=\"breadcrumb__list\">
    {% for item in breadcrumb %}
      <li class=\"breadcrumb__item\">
        {% if item.url %}
          <a href=\"{{ item.url }}\" class=\"breadcrumb__link !text-white text-base lg:text-xl\">{{ item.text }}</a>
        {% else %}
          {{ item.text }}
        {% endif %}
      </li>
...
{% endif %}
", "themes/custom_theme/templates/system/breadcumbs/breadcrumb.html.twig", "C:\\Users\\Admin\\Desktop\\New folder\\saigon-academy\\web\\themes\\custom_theme\\templates\\system\\breadcumbs\\breadcrumb.html.twig");
    }
